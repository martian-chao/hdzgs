...
public class HdZgsDao {
    ...
    public boolean isExist(String zcrq, String lwdw, String seqnum) {
        String sql = "select count(*) from z_zcrbjh where zcrq=? and lwdw=? and seqnum=?";
    ...
    public int updateHdHz(HdModel hdModel) {
        String sql = "update z_zcrbjh set qqcs=:qqcs,qqds =:qqds,qqcz =:qqcz,pzcs =:pzcs,pzds =:pzds,pzcz =:pzcz," +
    ...
    public int updateHdHz2(HdModel hdModel) {
        String sql = "update z_zcrbjh set qqcs =:qqcs,qqds =:qqds,qqcz =:qqcz,pzcs =:pzcs,pzds =:pzds,pzcz =:pzcz," +
                ...
                "   jdzc4 =:jdzc4,jdzcds4 =:jdzcds4,jddz4 =:jddz4,zccz =:zccz,ope4 =:ope4,yjqr=:yjqr," +
                "   yjqrds=:yjqrds,ystz=:ystz,ystzhz=:ystzhz,lkyy=:lkyy,lkyybz=:lkyybz,auto=:auto" +
                "   where zcrq=:zcrq and lwdw=:lwdw and seqnum=:seqnum";
        return namedParameterJdbcTemplate.update(sql, new BeanPropertySqlParameterSource(hdModel));
    }
    ...
    public int saveHdHz(HdModel hdModel) {
        String sql = "insert into z_zcrbjh(zcrq, lwdw, seqnum, jhid, pzycfh, qqlx, qqcs, qqds, qqcz, pzcs, pzds, pzcz," +
                ...
                "   yjcs3, yjds3, ope3, jdzc4, jdzcds4, jddz4, zccz, ope4, htddh, ffj, fz, fzhzzm, fhdwdm, fhdwsrm, " +
                ...
                "   :jdzc4,:jdzcds4,:jddz4,:zccz,:ope4,:htddh,:ffj,:fz,:fzhzzm,:fhdwdm,:fhdwsrm,:fhdwmc,:fhdwtz,:fhdwtzm," +
                ...
                "   :shjycs,:tzyybz,:lkyy1cs,:lkyy2cs,:lkyy3cs,:lkyy4cs,:lkyy5cs,:lkyy6cs,:lkyy,:lkyybz,:auto,:fj)";
        return namedParameterJdbcTemplate.update(sql, new BeanPropertySqlParameterSource(hdModel));
    ...
    public boolean isExistLcrq(String ljdm, String lcrq) {
        String sql = "select count(*) from hd_lcrq where ljdm=? and lcrq=?";
